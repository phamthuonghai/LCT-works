    ...
    def construct(self, args):
        ...
        with self.session.graph.as_default():
            ...
            def generator(z):
                ...
                features = tf.layers.dense(z, 128, activation=tf.nn.relu)
                features = tf.layers.dense(features, self.HEIGHT * self.WIDTH, activation=tf.nn.sigmoid)
            ...
            def discriminator(image):
                ...
                features = tf.layers.dense(features, 128, activation=tf.nn.relu)
